      ...
      <div className="mx-auto max-w-7xl">
        ...
        >
          <div className="flex items-center">
            <span className="mr-4 text-2xl font-mono text-primary-white">03.</span>
          ...
          >
            <p className="max-w-3xl leading-relaxed text-gray-400">
              Each project showcases my expertise in <span className="text-primary-white">full-stack development</span> and problem-solving ability.
              From <span className="text-primary-white">web applications</span> to <span className="text-primary-white">product-focused experiences</span>,
              these works highlight modern architecture, thoughtful UI, and a strong commitment to <span className="text-primary-white">clean code</span>.
            </p>

            <Link
              to="/project"
              className="inline-flex items-center gap-2 text-sm font-medium text-green-400 transition-colors hover:text-green-300"
            >
              See all projects
        ...
        <div className="grid grid-cols-1 gap-6 md:grid-cols-2 xl:grid-cols-3">
          {projectData.map((project, index) => (
            <motion.article
              key={project.id}
              className="group relative overflow-hidden rounded-2xl border border-gray-800/70 bg-gray-800/40 p-5 shadow-[0_10px_30px_rgba(0,0,0,0.18)] transition-all duration-300 hover:-translate-y-1 hover:border-green-400/20 hover:bg-gray-800/70"
              ...
              <div className="space-y-4">
                ...
                <div className="flex flex-wrap gap-2">
                  {project.tags.map((tag, i) => (
                    <motion.span
                      key={i}
                      className="rounded-full bg-gray-900/70 px-2.5 py-1 text-[11px] font-medium text-green-400/90 transition-colors group-hover:bg-green-400/10"
                      whileHover={{
                        scale: 1.05,
