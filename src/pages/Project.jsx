...
export const Project = () => {
  ...
  return (
    <SidebarLayout>
      <section className="py-16 px-6 sm:px-12 md:px-20 lg:px-28 min-h-screen">
        <motion.div
          className="mb-12"
          initial={{ opacity: 0 }}
        ...
        >
          <div className="flex items-center mb-6">
            <Link to="/" className="text-gray-400 hover:text-green-400 flex items-center transition-colors">
          ...
          <div className="flex items-center">
            <h1 className="text-3xl font-bold text-gray-100">All <span className="text-green-400">Projects</span></h1>
